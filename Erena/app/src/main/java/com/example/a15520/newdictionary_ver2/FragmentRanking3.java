...
import static com.example.a15520.newdictionary_ver2.GlobalVariable.getInstance;

/**
 * Created by 15520 on 12/22/2017.
 */

public class FragmentRanking3 extends Fragment {

    ListView _lvRanking;
    RankingAdapter _adapterRanking;
    private DatabaseReference mUserRef;

    public FragmentRanking3() {
    ...
    private void SortData(ArrayList<UserModel> listID) {
            ...
            Collections.sort(listID,new UserChainedComparator(new UserScore3Comparator(),new UserRankComparator() ));
    }
    ...
    public void onStart() {
        ...
        _adapterRanking = new RankingAdapter(_listID, getActivity(),3);
