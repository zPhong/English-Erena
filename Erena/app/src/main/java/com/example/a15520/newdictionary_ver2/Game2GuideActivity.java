...
public class Game2GuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game2_guide);

        _btnStartGame = (Button) findViewById(R.id.btnStartGame2);

        _btnStartGame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Game2GuideActivity.this, Game2Activity.class);
        ...
        _tvGuide =(TextView )findViewById(R.id.tvGame2Guide);
        String htmlsource =
                "<h2 style=\"text-align: center;\"><span style=\"color: #fc7677;\"><strong>Guide for Fill cup</strong></span></h2>\n" +
